...
import 'package:travel_app/screen/Admin/tourDetails.dart';
import '../../model/joinModel.dart';
import '../../utils/color_utils.dart';

class TourRequests extends StatefulWidget {
  const TourRequests({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dataList.isEmpty
          ...
          //     color: kPColor,
          //   ))
          ? Center(child: Text("No Tour Requests",style: GoogleFonts.openSans(color: black,),),)
          : ListView.builder(
